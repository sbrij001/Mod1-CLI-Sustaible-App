...
#facts
fla_fact1 = Fact.create(fact: "Increase comfort and reduce energy consumption by controlling the indoor temperature. \n You can control the temperature in your living space by installing low cost, easy-to-use thermostats and automatic radiator controls that will save energy and increase comfort. \n Insulate your windows by installing storm windows, which will reduce drafts and lower your energy bills." )
fla_fact2 = Fact.create(fact: "If you want to be more sustainable why not start at your home? Make sure your home has adequate insulation and energy-saving windows, and use a programmable thermostat for more efficient heating and cooling — and, of course, energy-saving lightbulbs for more efficient lighting.")
fla_fact3 = Fact.create(fact: "Have a garden and want to create rich soil. Try composting! For one, it’s free. You get to use kitchen waste, lawn clippings, leaves and other vegetation that would otherwise get thrown away. In fact, you might even save money on landfill fees.")

nyc1 = Fact.create(fact: "Shop at farmers’ markets. Eating local is good to lower food miles. Meaning lowering the distance food must travel before it ends up on your plate. These little changes can make a strong difference in the environment.")
nyc2 = Fact.create(fact: "Recycling is one of the easiest ways to 'go green' and promote sustainability in the city. GrowNYC has sponsored city-wide recycling initiatives by putting curbside recycling bins all over the city.")
nyc3 = Fact.create(fact: "Stay in NYC. Although it may seem counterintuitive, living in dense,
